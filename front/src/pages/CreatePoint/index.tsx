import React, {useEffect, useState, ChangeEvent,FormEvent
} from 'react';
...
//array ou objeto: manualmente informar o tipo da variavel -->State
interface Item{
    id: number;
    titulo: string;
    image_url: string
...
},[selectedUF]);//qnd a func deve executar
